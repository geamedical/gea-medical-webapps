            ...
            <v-footer app inset padless absolute>
                <v-card flat tile class="text-center flex" color="footer">
                    ...
                    <v-card-text class="pt-0">
                        GEA Medical Tower, 7th Floor, Cengkareng Businnes City, Jl. Atang Sanjaya No.21, RT.006/RW.007, Benda, Tangerang City, Banten 15125
                    </v-card-text>
                    <v-card-text>
                        {{ new Date().getFullYear() }} — <strong>PT. MEGA PRATAMA MEDICALINDO</strong>
                    </v-card-text>
                </v-card>
            </v-footer>
        </v-app>
